...
public class OrcStringTypeFactory implements OrcTypeFactory<OrcStringType> {
    ...
    public static class OrcStringType extends AbstractOrcType<BytesColumnVector> {
        ...
        public DataCell readValueNonNull(final BytesColumnVector columnVector, final int rowInBatchOrZero) {
            return new StringCell(new String(columnVector.vector[rowInBatchOrZero],
                columnVector.start[rowInBatchOrZero], columnVector.length[rowInBatchOrZero], StandardCharsets.UTF_8));
        }

        /*
         * TODO TODO TODO new method with byte[]
         */
        public final void writeString(final BytesColumnVector columnVector, final int rowInBatch, final String string) {
        ...
        public String readString(final BytesColumnVector byteVectorColumn, final int rowInBatch) {
