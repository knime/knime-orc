 ...
 *
 * History
 *   01.05.2018 ("Mareike Hoeger, KNIME GmbH, Konstanz, Germany"): created
 */
...
public class OrcListTypeFactory {
     ...
     */
    public OrcListType create(final OrcType<ColumnVector> subtype) {
    ...
    public static class OrcListType extends AbstractOrcType<ListColumnVector> {
        ...
        protected DataCell readValueNonNull(final ListColumnVector columnVector, final int rowInBatchCorrected) {
            Collection<DataCell> cells = new ArrayList<>();
            ColumnVector chil = columnVector.child;
            long startRow = columnVector.offsets[rowInBatchCorrected];
            long end = startRow + columnVector.lengths[rowInBatchCorrected];
        ...
        protected void writeValueNonNull(final ListColumnVector columnVector, final int rowInBatch,
            ...
            int listsize = ((ListCell)cell).size();
            columnVector.child.ensureSize((int)(offset + listsize), true);

            Iterator<DataCell> iter = ((ListCell)cell).iterator();
